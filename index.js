...
localStorage.setItem("fav", JSON.stringify(fav));
  ...
  function createCard(elem, page) {
    ...
    prodTittle.innerText = elem.title;
    prodImg.src = elem.image;
    prodBasket.innerText = "Basket";
    prodFav.innerText = "Fav";
  
    prodTittle.className = "prodTittle";
    prodImg.className = "prodImg";
    prodCard.className = "prodCard";
    prodBasket.className = "prodBasket";
    prodFav.className = "prodFav";
  
    prodBasket.setAttribute("data", elem.id);
    prodFav.setAttribute("data", elem.id);
  
    prodCard.addEventListener("click", function (e) {
        window.location.href = `detail.html?id=${elem.id}`;
    });
    ...
    //   let elem = api.find((elem) => elem.id == e.target.getAttribute("data"));
        ...
        basket.push(e.target.getAttribute("data"));
        localStorage.setItem("basket", JSON.stringify(basket));
    });
    ...
    prodFav.addEventListener("click", (e) => {
      e.stopPropagation();
      // let elem = api.find((elem) => elem.id == e.target.getAttribute("data"));
      // createCard(elem, favPage);
      fav.push(e.target.getAttribute("data"));
      localStorage.setItem("fav", JSON.stringify(fav));
    });
  
    prodCard.append(prodImg, prodTittle, prodBasket, prodFav);
